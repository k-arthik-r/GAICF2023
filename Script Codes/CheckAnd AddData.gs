function sendDriveLinkToUser(e) {
  var userEmail = (e.values[3]).toLowerCase(); //email is in the second column
  var name = e.values[2];
  ...
  if (dataSheet) {
    ...
    for (var i = 2; i <= lastRow; i++) { // Assuming data starts from row 2
      if (dataSheet.getRange('B' + i).getValue() === userEmail) { // Assuming email is in column B
        var driveLink = dataSheet.getRange('E' + i).getValue(); // Assuming drive link is in column C
        ...
        `
          ...
          * {
          ...
          table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_row_2 .v-row-background-image--inner { background-position: 50% 80% !important; background-repeat: no-repeat !important; } #u_row_2 .v-row-background-image--outer { background-position: 50% 80% !important; background-repeat: no-repeat !important; } #u_row_2.v-row-background-image--outer { background-position: 50% 80% !important; background-repeat: no-repeat !important; } #u_content_image_5 .v-container-padding-padding { padding: 0px !important; } #u_content_image_5 .v-src-width { width: 100% !important; } #u_content_image_5 .v-src-max-width { max-width: 100% !important; } #u_content_image_5 .v-text-align { text-align: center !important; } #u_content_text_4 .v-container-padding-padding { padding: 40px 30px 60px !important; } #u_content_text_4 .v-text-align { text-align: justify !important; } #u_content_heading_5 .v-container-padding-padding { padding: 30px 20px 10px !important; } #u_content_heading_5 .v-text-align { text-align: center !important; } #u_content_text_7 .v-container-padding-padding { padding: 0px 20px 10px !important; } #u_content_text_7 .v-text-align { text-align: center !important; } }
              </style>
          ...
          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            <tbody>
              <tr>
                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:13px 10px 9px;font-family:arial,helvetica,sans-serif;" align="left">
                  
            <div class="v-text-align" style="font-family: 'Raleway',sans-serif; font-size: 13px; font-weight: 700; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
              <p style="line-height: 140%;">Vidyavardhaka College of Engineering</p>
            </div>
          ...
          <!--[if (mso)|(IE)]></td><![endif]-->
              ...
              <!--[if gte mso 9]>
                <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
                  <tr>
                    <td background="https://cdn.templates.unlayer.com/assets/1697780017963-Group%2075.png" valign="top" width="100%">
                <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
                  <v:fill type="frame" src="https://cdn.templates.unlayer.com/assets/1697780017963-Group%2075.png" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
                <![endif]-->
            
          <div id="u_row_2" class="u-row-container v-row-background-image--outer" style="padding: 0px;background-image: url('images/image-2.png');background-repeat: no-repeat;background-position: center center;background-color: transparent">
            <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
              <div class="v-row-background-image--inner" style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
          ...
          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <table height="0px" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 3px solid #e67e23;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
              <tbody>
                <tr style="vertical-align: top">
          ...
          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            <tbody>
              <tr>
                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:18px 0px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                  
            <h1 class="v-text-align" style="margin: 0px; color: #211d1b; line-height: 100%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 25px; font-weight: 700;">2023</h1>
          ...
          <table id="u_content_text_4" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            <tbody>
              <tr>
                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 90px 22px;font-family:arial,helvetica,sans-serif;" align="left">
                  
            <div class="v-text-align" style="font-family: 'Montserrat',sans-serif; font-size: 13px; color: #d9d9d9; line-height: 140%; text-align: justify; word-wrap: break-word;">
              <p style="line-height: 140%;">Dear ${name} ,</p>
          <p style="line-height: 140%;"> </p>
          <p style="line-height: 140%;">The GAIF Event Management Team would like to express our heartfelt gratitude for your active participation and unwavering support at the Google Campus AI Fest 2023 hosted at Vidyavardhaka College of Engineering. Your valuable insights and enthusiastic engagement significantly contributed to the resounding success of the event.</p>
          <p style="line-height: 140%;"> </p>
          <p style="line-height: 140%;">Thank you once again for your invaluable contribution and dedication. Your presence was truly appreciated and made a meaningful difference.</p>
          ...
          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div class="v-text-align" style="font-family: 'Raleway',sans-serif; font-size: 13px; font-weight: 700; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
              <p style="line-height: 140%;"><span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiMDJIanNuOTdETEVySVV5NGdzMnVoTyIsInBhc3RlSUQiOjIwNTE2OTY3NjIsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;" style="line-height: 18.2px;"></span>You Can Access your Participation E - Certification Here:</p>
          <p style="line-height: 140%;"> </p>
            </div>
          ...
          <div class="v-text-align" align="center">
            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:43px; v-text-anchor:middle; width:134px;" arcsize="9.5%"  stroke="f" fillcolor="#e67e23"><w:anchorlock/><center style="color:#000000;font-family: 'Raleway',sans-serif; "><![endif]-->
              <a href="${driveLink}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #e67e23; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: 'Raleway',sans-serif; font-size: 19px;font-weight: 700; ">
                <span style="display:block;padding:10px 20px;line-height:120%;">Click Here</span>
              </a>
          ...
          <table id="u_content_text_7" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            <tbody>
              <tr>
                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:9px 60px 12px 35px;font-family:arial,helvetica,sans-serif;" align="left">
                  
            <div class="v-text-align" style="font-family: 'Montserrat',sans-serif; font-size: 13px; font-weight: 700; line-height: 170%; text-align: left; word-wrap: break-word;">
              <p style="line-height: 170%;">If you have any queries related to the E - Certificate, please contact:</p>
          <p style="line-height: 170%;">Karthik R - +91 7795123170</p>
          <p style="line-height: 170%;">Hithendra B M - +91 8088373416 </p>
            </div>
        ...
        var subject = "VVCE GAICF E-Certificate";
